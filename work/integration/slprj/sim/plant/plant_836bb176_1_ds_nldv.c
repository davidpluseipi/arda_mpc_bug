...
int32_T plant_836bb176_1_ds_nldv ( const NeDynamicSystem * LC , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 122 ] = { false , false , true , false , true , true , true ,
...
, false , false , false , false , false , false , false , false , false ,
false , false , false , false , false , false , false , false , false , false
} ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 122 ] ; ( void ) t1 ; (
void ) LC ; out = t2 -> mNLDV ; for ( b = 0 ; b < 122 ; b ++ ) { t0 [ b ] =
