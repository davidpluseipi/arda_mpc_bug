...
void plant_836bb176_1_dae ( NeDae * * dae , const NeModelParameters *
...
ne_dae_create ( dae , plant_836bb176_1_dae_ds ( ne_allocator ) , NULL , FALSE
, rtpValues , * solverParams , * modelParams , linear_algebra_ptr , NULL ,
NULL , NULL , ne_allocator , DAEMON_CHOICE_NONE ) ; }
