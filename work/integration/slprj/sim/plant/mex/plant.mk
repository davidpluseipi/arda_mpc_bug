...
## 
## Makefile     : plant.mk
## Generated on : Tue Dec 07 16:43:47 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/plant_msf.mexw64
...
MODELREF_LINK_RSPFILE     = plant_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/plant_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/plant/plant_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = plant_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/dmeissner/stuff/arda/work/integration/slprj/sim/plant/plantlib.lib
...
plant_msf.obj : $(START_DIR)/slprj/sim/plant/plant_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
