...
int32_T plant_836bb176_1_ds_tdxy_p ( const NeDynamicSystem * LC , const
...
out = t2 -> mTDXY_P ; out . mNumCol = 122ULL ; out . mNumRow = 11ULL ; for (
b = 0 ; b < 123 ; b ++ ) { out . mJc [ b ] = _cg_const_1 [ b ] ; } out . mIr
